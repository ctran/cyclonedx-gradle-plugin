...
```kotlin
tasks.cyclonedxDirectBom {
    // Include only SHA-256 (most common, secure default)
...
// Or exclude weak algorithms from all projects
allprojects {
    tasks.cyclonedxDirectBom {
        // Exclude MD5 and SHA-1, keep SHA-256 and SHA-512
        hashAlgorithms = listOf("SHA-256", "SHA-512", "SHA3-256", "SHA3-512")
    }
}
```
